...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=f'SupportGenie AI <{EMAIL_HOST_USER}>' if EMAIL_HOST_USER else 'SupportGenie AI <noreply@supportgenie.ai>')
